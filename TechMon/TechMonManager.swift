...
class TechMonManager {
    ...
    init() {
        ...
        // キャラクターの設定
        player = Character(name: "勇者", imageName: "yusya", attackPoint: 30, maxHP: 100, maxTP: 100, maxMP: 20)
        enemy = Character(name: "ドラゴン", imageName: "monster", attackPoint: 20, maxHP: 400, maxTP: 0, maxMP: 35)
    }
